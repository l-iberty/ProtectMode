...
LABEL_DESC_CGATE_DEST:	Descriptor	0,		CGateCodeLen-1, DA_C32+DPL_1	; 调用门目标代码段描述符
; 门
;				Selector		Offset	Argc	Attr
LABEL_DESC_CGATE:	Gate	Selector_CGate_Dest,	0,	4,	DA_CGATE	; 调用门
...
Selector_CGate		equ	LABEL_DESC_CGATE	- LABEL_GDT	; 调用门选择子
...
LABEL_SEG_CODE32:
	...
	mov	al, 'e'
	push	eax			; arg4
	call	Selector_CGate:0	; 远调用，返回时需使用 retf
